...
<div class="file-grid">
  <div class="file-item card">
    ...
    <div><a href="/portfolio-toby-draper/downloads/RavenStack_SaaS_Analysis/RavenStack_Case_Study.pdf" download><strong>Case Study</strong></a></div>
  </div>
  <div class="file-item card">
    <img src="/portfolio-toby-draper/icons/IPy-logo.png" class="file-icon" alt="Jupyter Notebook icon">
    <div><a href="/portfolio-toby-draper/downloads/RavenStack_SaaS_Analysis/RavenStack_Final_V1_0.ipynb" download><strong>Code (Jupyter Notebook)</strong></a></div>
  </div>
</div>
